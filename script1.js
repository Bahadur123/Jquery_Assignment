...
var graph=function(data){
  ...
  var color = d3.scale.category20();  // color scale of category10 with customised range of colors
  ...
  // d3 function to load JSON data from a json file
   data.forEach(function(d){
     d.year=+d.year;
     d.above=+d.above;
     d.below_and_under=+d.below_and_under;
   });

   var categories=["above","below_and_under"];
...
legend.append("rect")
  ...
  .style("fill", color);
       ...
       legend.append("text")
           ...
           .style("text-anchor", "end")
           .style("fill","green")
           .text(function(d,i) { return categories[i]+" $500"; });
};
